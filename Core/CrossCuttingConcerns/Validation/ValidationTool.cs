...
namespace Core.CrossCuttingConcerns.Validation
{
    public static class ValidationTool
    {
        public static void Validate(IValidator validator,object entity)
        {
            ...
            var result = validator.Validate(context);//Contexti Validate et , parametre olarak verdiğimiz , kendi oluşturduğumuz validasyosyon sınıfımıza göre hepsi Business/ValidationRules/FluentValidation içerisinde
